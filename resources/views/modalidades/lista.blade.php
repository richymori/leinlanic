...
<tr>
    ...
    <td>
    <a href="/modalidades/create" ><button type="button" class="button button1">Agregar </a></button>

   <a href="/modalidades/edit/{{$item->id}}"><button type="button" class="button button1">Editar </a></button>
