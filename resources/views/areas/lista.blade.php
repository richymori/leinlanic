...
<tr>
    ...
    <td>
    <a href="/areas/create" ><button type="button" class="button button1">Agregar </a></button>

   <a href="/areas/edit/{{$item->id}}"><button type="button" class="button button1">Editar </a></button>
